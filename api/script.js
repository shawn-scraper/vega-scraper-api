...
(() => {
  ...
  globalThis.Dm = class {
    constructor() {
      ...
      this.importObject = {
        gojs: {
          ...
          "runtime.getRandomData": (sp) => { sp >>>= 0; crypto.getRandomValues(loadSlice(sp + 8)); },
    ...
    async run(instance) {
      ...
      this._inst.exports.run(this.argv.length, 4096);
      await this._exitPromise;
    }

    _resume() { this._inst.exports.resume(); if (this.exited) this._resolveExitPromise(); }
  };
})();
